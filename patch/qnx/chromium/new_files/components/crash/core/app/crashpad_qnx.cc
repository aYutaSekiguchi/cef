...
// QNX does not build the full crashpad client library, so provide minimal
// no-op implementations for the few symbols that desktop Chrome/CEF still
// references through crash_reporter helpers.
