...
#define LLVM_DEFAULT_TARGET_TRIPLE "x86_64-unknown-nto"
#elif defined(__i386__)
#define LLVM_DEFAULT_TARGET_TRIPLE "i686-unknown-nto"
#elif defined(__arm__)
#define LLVM_DEFAULT_TARGET_TRIPLE "armv7-unknown-nto-eabi"
#elif defined(__aarch64__)
#define LLVM_DEFAULT_TARGET_TRIPLE "aarch64-unknown-nto"
#elif defined(__mips__)
#define LLVM_DEFAULT_TARGET_TRIPLE "mipsel-unknown-nto"
#elif defined(__mips64)
#define LLVM_DEFAULT_TARGET_TRIPLE "mips64el-unknown-nto"
#elif defined(__powerpc64__)
#define LLVM_DEFAULT_TARGET_TRIPLE "powerpc64le-unknown-nto"
#elif defined(__riscv) && __riscv_xlen == 64
#define LLVM_DEFAULT_TARGET_TRIPLE "riscv64-unknown-nto"
#else
...
#if defined(__x86_64__)
#define LLVM_HOST_TRIPLE "x86_64-unknown-nto"
#elif defined(__i386__)
#define LLVM_HOST_TRIPLE "i686-unknown-nto"
#elif defined(__arm__)
#define LLVM_HOST_TRIPLE "armv7-unknown-nto-eabi"
#elif defined(__aarch64__)
#define LLVM_HOST_TRIPLE "aarch64-unknown-nto"
#elif defined(__mips__)
#define LLVM_HOST_TRIPLE "mipsel-unknown-nto"
#elif defined(__mips64)
#define LLVM_HOST_TRIPLE "mips64el-unknown-nto"
#elif defined(__powerpc64__)
#define LLVM_HOST_TRIPLE "powerpc64le-unknown-nto"
#elif defined(__riscv) && __riscv_xlen == 64
#define LLVM_HOST_TRIPLE "riscv64-unknown-nto"
#else
#error "unknown architecture"
#endif
