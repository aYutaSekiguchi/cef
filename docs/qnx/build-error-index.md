...
rg -n "ceftests|AudioManager|CloudProfileReportingServiceFactory|NotificationPlatformBridge|BrowserNativeWidget|DeveloperToolsAvailabilityAllowlist|devtools.availability_allowlist|AxViewportCollapseTest|gtest_list_tests" docs/qnx/history/build-errors/test
