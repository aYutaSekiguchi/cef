...
| `//chromeos/ash/components/dbus/*` | ~80 subdirs | All ChromeOS-specific D-Bus clients (anomaly_detector, attestation, audio, biod, chaps, cec_service, cicerone, concierge, cros_disks, cryptohome, debug_daemon, dlcservice, easy_unlock, featured, fwupd, gnubby, hammerd, hermes, human_presence, image_loader, kerberos, lorgnette_manager, oobe_config, os_install, patchpanel, pciguard, printscanmgr, resourced, rmad, seneschal, services, session_manager, shill, spaced, swap_management, system_clock, system_proxy, typecd, upstart, usb, userdataauth, vm_plugin_dispatcher) |
